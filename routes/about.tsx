  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="了解 CloseAI 图库的功能特点和使用方法"
        />
      </Head>
            ...
            <div class="prose dark:prose-invert max-w-none">
              ...
              <div class="bg-orange-50 dark:bg-orange-900/20 border-l-4 border-orange-500 p-6 mb-8">
                ...
                <ol class="list-decimal pl-5 space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <li>
                    刷新页面或发起请求。查找 API 调用（例如到 `conversation`
                    的请求）。
                  </li>
                  <li>
                    访问令牌：在请求头中找到 "Authorization"（复制 "Bearer "
                    后的值）。
                  </li>
                  <li>
                    团队 ID：在请求头中找到
                    `chatgpt-account-id`（仅在团队工作区中需要）。
                  </li>
                </ol>
              </div>
              ...
              <div class="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-6 mb-8">
                ...
                <ul class="list-disc pl-5 space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  <li>
                    <strong>批量导出</strong>：一键下载所有 ChatGPT 生成的图像为
                    ZIP 文件
                  </li>
                  <li>
                    <strong>元数据支持</strong>：可选择包含图像元数据信息（JSON
                    格式）
                  </li>
                  <li>
                    <strong>
                      智能命名
                    </strong>：文件按日期和标题自动命名，便于管理
                  </li>
                  <li>
                    <strong>
                      后端处理
                    </strong>：服务器端压缩，支持大量图像无内存限制
                  </li>
                  <li>
              ...
              <p class="mb-4 text-gray-600 dark:text-gray-300">
                本项目采用 MIT 开源协议，由 YuenSzeHong 开发。欢迎访问 GitHub
                仓库查看源代码、报告问题或贡献代码。
              </p>
              <a
